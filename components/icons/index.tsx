...
export const HeartPulseIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    <path d="M3.22 12H9.5l.7-1.5L13.5 14l.7-1.5h4.82" />
  </svg>
);
...
export const BrainCircuitIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M15 13a3 3 0 1 0-5.993.13"/>
        <path d="M15 13a3 3 0 1 1 5.993.13"/>
        <path d="M9 13a3 3 0 1 1-5.993-.13"/>
        <path d="M9.003 12.869A2.998 2.998 0 1 0 12 10"/>
        <path d="M14.997 12.869A2.998 2.998 0 1 1 12 10"/>
...
export const PiggyBankIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M10 20.5c0 .8.7 1.5 1.5 1.5h1c.8 0 1.5-.7 1.5-1.5v-1.5a2 2 0 0 1-3 0v1.5Z"/>
        <path d="M10 10.5c0 .8.7 1.5 1.5 1.5h1c.8 0 1.5-.7 1.5-1.5v-1a2 2 0 0 1-3-1.7V5c0-1.1.9-2 2-2h1"/>
        <path d="M18.5 7.5c.8 0 1.5.7 1.5 1.5v3a2 2 0 0 1-2 2h-1a2 2 0 0 0-2 2v1.5a2.5 2.5 0 0 1-5 0V17a2 2 0 0 0-2-2h-1a2 2 0 0 1-2-2v-3c0-.8.7-1.5 1.5-1.5"/>
    </svg>
);
...
export const BedIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M2 4v16h20V4Z"/><path d="M2 10h20"/><path d="M6 8v2"/><path d="M10 8v2"/></svg>
);

export const FootprintsIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M4 16v-2.38c0-1.4.9-2.62 2.2-2.62h0a2.4 2.4 0 0 1 2.4 2.4v.38"/><path d="M5.4 12.88A2.4 2.4 0 0 1 7.8 13h0c1.3 0 2.2-1.22 2.2-2.62V8"/><path d="M17.8 22c1.3 0 2.2-1.22 2.2-2.62v-2.38c0-1.4-.9-2.62-2.2-2.62h0a2.4 2.4 0 0 0-2.4 2.4v.38"/><path d="M16.2 16.12A2.4 2.4 0 0 0 13.8 16h0c-1.3 0-2.2-1.22-2.2-2.62V11"/></svg>
);
...
export const SlackIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M12.55 5.5h-1.1a2 2 0 0 0-2 2v1.1a2 2 0 0 0 2 2h1.1a2 2 0 0 0 2-2V7.5a2 2 0 0 0-2-2z" fill="#36C5F0"/>
    <path d="M18.5 12.55v-1.1a2 2 0 0 0-2-2h-1.1a2 2 0 0 0-2 2v1.1a2 2 0 0 0 2 2h1.1a2 2 0 0 0 2-2z" fill="#2EB67D"/>
    <path d="M11.45 18.5h1.1a2 2 0 0 0 2-2v-1.1a2 2 0 0 0-2-2h-1.1a2 2 0 0 0-2 2v1.1a2 2 0 0 0 2 2z" fill="#ECB22E"/>
    <path d="M5.5 11.45v1.1a2 2 0 0 0 2 2h1.1a2 2 0 0 0 2-2v-1.1a2 2 0 0 0-2-2H7.5a2 2 0 0 0-2 2z" fill="#E01E5A"/>
  </svg>
);

export const OuraIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const AppleIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M15.59,13.71a4.3,4.3,0,0,1-2.38,3.22,4.34,4.34,0,0,1-3.87-.92,10.61,10.61,0,0,1-2-2.73,12.43,12.43,0,0,1-.9-4.2,6.59,6.59,0,0,1,3.28-5.83,6.82,6.82,0,0,1,6.23,1.3,1.43,1.43,0,0,0,1.88.13,1.42,1.42,0,0,0,.62-1.8,9.7,9.7,0,0,0-8.86-4.2C6.1,1.56,2,5.63,2,10a8.32,8.32,0,0,0,1.53,5,9.45,9.45,0,0,0,4.24,4.24,6.42,6.42,0,0,0,5.2,0,5.88,5.88,0,0,0,3.39-2.22,1.38,1.38,0,0,0-.77-2.35Z"/><path d="M18.82,1.22a5.46,5.46,0,0,0-4,2.3,6.29,6.29,0,0,0-1.25,4.37,4.3,4.3,0,0,1,2.37-3.23,4.33,4.33,0,0,1,3.87.93,10.4,10.4,0,0,1,2,2.72,11.83,11.83,0,0,1,.89,4.12,6.53,6.53,0,0,1-3.28,5.83,6.81,6.81,0,0,1-6.23-1.3,1.43,1.43,0,0,0-1.88-.13,1.42,1.42,0,0,0-.62,1.8,9.7,9.7,0,0,0,8.86,4.2,12.33,12.33,0,0,0,4.41-1.39C25.59,16.8,23.3,9.52,18.82,1.22Z" transform="translate(-1.41 0.76)"/>
  </svg>
);

export const MicrosoftIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M11.4,11.4H2V2h9.4ZM22,11.4V2h-9.4v9.4Zm-9.4,10.6H2V12.6h9.4ZM22,22h-9.4V12.6H22Z" />
    </svg>
);
...
export const QuoteIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M3 21c3 0 7-1 7-8V5c0-1.25-.75-2-2-2-1.25 0-2 .75-2 2v2"/>
    <path d="M17 21c3 0 7-1 7-8V5c0-1.25-.75-2-2-2-1.25 0-2 .75-2 2v2"/>
  </svg>
);